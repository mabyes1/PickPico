                ...
                .put("properties", new JSONObject()
                        ...
                        .put("actions", new JSONObject()
                                ...
                                .put("items", new JSONObject()
                                        ...
                                        .put("minLength", 1)
                                        .put("maxLength", 80)))
                        .put("customAction", new JSONObject()
                                .put("type", "string")
                                .put("maxLength", 80)
                                .put("description", "Optional context-specific fourth action shown on the HUMAN HELP screen and mapped to the Custom hardware key."))
